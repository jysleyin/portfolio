...
import benefitbridgeTransparent from '../assets/benefitbridge-transparent.png'

export default function BenefitBridge() {
  const navigate = useNavigate()
  const project = projects.find((p) => p.slug === 'benefitbridge')
      ...
      <div className="max-w-6xl mx-auto p-8 md:p-12">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="mt-10 space-y-8 text-slate-900">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3">Reflection</h2>
              <p className="leading-relaxed whitespace-pre-wrap">{project.reflection}</p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mb-3">What makes this work unique</h2>
              <ul className="list-disc list-inside space-y-2">
                {project.uniqueness?.map((item, idx) => (
                  <li key={idx}>{item}</li>
                ))}
              </ul>
            </section>
