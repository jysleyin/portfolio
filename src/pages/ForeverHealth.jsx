...
import foreverhealthTransparent from '../assets/foreverhealth-transparent.png'

export default function ForeverHealth() {
  const navigate = useNavigate()
  const project = projects.find((p) => p.slug === 'forever-health')
      ...
      <div className="max-w-6xl mx-auto p-8 md:p-12">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="mt-10 space-y-8 text-slate-900">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3">Unique value</h2>
              <ul className="list-disc list-inside space-y-2">
